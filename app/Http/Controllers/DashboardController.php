...
class DashboardController extends Controller
{
    public function index(){
    	...
    	return view('dashboard',compact('jlh_outlet','jlh_transaksi','pengeluaran','pendapatan','pendapatan_prev_month','pengeluaran_prev_month','transaksi_prev_month','pen_jan','pen_feb','pen_mar','pen_apr','pen_mei','pen_jun','pen_jul','pen_aug','pen_sept','pen_oct','pen_nov','pen_dec','year'));
    }
}
